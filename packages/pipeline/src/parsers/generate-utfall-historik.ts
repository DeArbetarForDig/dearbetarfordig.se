...
> = {
  '2022': [
    ...
    {
      nämnd: 'Idrotts- och föreningsnämnden',
      intäkter: 167,
      kostnader: -732,
      kommunbidrag: 571,
      resultat: 6,
  ...
  '2024': [
    ...
    {
      nämnd: 'Inköps- och upphandlingsnämnden',
      intäkter: 130,
      kostnader: -134,
      kommunbidrag: 6,
      resultat: 2,
  ...
  for (const n of nämnder) {
    ...
    if (nämndId) {
      edges.push({
        ...
        to: nämndId,
        typ: 'utfall_för',
        label: `${n.resultat > 0 ? '+' : ''}${n.resultat} mnkr`,
      })
    }
    if (direktörId) {
      edges.push({
