...
- Ett enda commit-meddelande innehöll ett branch-namn med ett ord skrivet med kyrilliska tecken (betydde "skuld") — fixat separat med `git filter-repo --message-callback` → `typecheck-debt`.
